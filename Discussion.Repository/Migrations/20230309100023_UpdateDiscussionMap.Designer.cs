...
namespace Discussion.Repository.Migrations
{
    ...
    [Migration("20230309100023_UpdateDiscussionMap")]
    partial class UpdateDiscussionMap
    {
            ...
            modelBuilder.Entity("Discussion.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(2758),
                            Deleted = false,
                            FirstName = "Admin",
                            LastName = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(7236),
                            Deleted = false,
                            FirstName = "Adam",
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(7248),
                            Deleted = false,
                            FirstName = "Joe",
                            LastName = "Parker"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(7252),
                            Deleted = false,
                            FirstName = "Patrick",
                            LastName = "Gargoles"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(7255),
                            Deleted = false,
                            FirstName = "Shannon",
                            LastName = "Jones"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 0, 23, 117, DateTimeKind.Local).AddTicks(7257),
                            Deleted = false,
                            FirstName = "Hurish",
                            LastName = "Williams"
                        });
