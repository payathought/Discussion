...
namespace Discussion.Repository.Migrations
{
    ...
    [Migration("20230309093215_UpdateRelationships1")]
    partial class UpdateRelationships1
    {
            ...
            modelBuilder.Entity("Discussion.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 906, DateTimeKind.Local).AddTicks(5881),
                            Deleted = false,
                            FirstName = "Admin",
                            LastName = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 907, DateTimeKind.Local).AddTicks(659),
                            Deleted = false,
                            FirstName = "Adam",
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 907, DateTimeKind.Local).AddTicks(671),
                            Deleted = false,
                            FirstName = "Joe",
                            LastName = "Parker"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 907, DateTimeKind.Local).AddTicks(674),
                            Deleted = false,
                            FirstName = "Patrick",
                            LastName = "Gargoles"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 907, DateTimeKind.Local).AddTicks(677),
                            Deleted = false,
                            FirstName = "Shannon",
                            LastName = "Jones"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 32, 14, 907, DateTimeKind.Local).AddTicks(680),
                            Deleted = false,
                            FirstName = "Hurish",
                            LastName = "Williams"
                        });
