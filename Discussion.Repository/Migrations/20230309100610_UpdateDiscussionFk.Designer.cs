...
namespace Discussion.Repository.Migrations
{
    ...
    [Migration("20230309100610_UpdateDiscussionFk")]
    partial class UpdateDiscussionFk
    {
            ...
            modelBuilder.Entity("Discussion.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(4005),
                            Deleted = false,
                            FirstName = "Admin",
                            LastName = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(9181),
                            Deleted = false,
                            FirstName = "Adam",
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(9193),
                            Deleted = false,
                            FirstName = "Joe",
                            LastName = "Parker"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(9197),
                            Deleted = false,
                            FirstName = "Patrick",
                            LastName = "Gargoles"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(9200),
                            Deleted = false,
                            FirstName = "Shannon",
                            LastName = "Jones"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 18, 6, 10, 273, DateTimeKind.Local).AddTicks(9202),
                            Deleted = false,
                            FirstName = "Hurish",
                            LastName = "Williams"
                        });
