...
namespace Discussion.Repository.Migrations
{
    ...
    [Migration("20230309093619_UpdateEntityMap")]
    partial class UpdateEntityMap
    {
            ...
            modelBuilder.Entity("Discussion.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 648, DateTimeKind.Local).AddTicks(7323),
                            Deleted = false,
                            FirstName = "Admin",
                            LastName = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 649, DateTimeKind.Local).AddTicks(2334),
                            Deleted = false,
                            FirstName = "Adam",
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 649, DateTimeKind.Local).AddTicks(2350),
                            Deleted = false,
                            FirstName = "Joe",
                            LastName = "Parker"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 649, DateTimeKind.Local).AddTicks(2354),
                            Deleted = false,
                            FirstName = "Patrick",
                            LastName = "Gargoles"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 649, DateTimeKind.Local).AddTicks(2358),
                            Deleted = false,
                            FirstName = "Shannon",
                            LastName = "Jones"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 36, 19, 649, DateTimeKind.Local).AddTicks(2360),
                            Deleted = false,
                            FirstName = "Hurish",
                            LastName = "Williams"
                        });
