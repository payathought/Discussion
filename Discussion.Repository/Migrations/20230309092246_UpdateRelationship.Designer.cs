...
namespace Discussion.Repository.Migrations
{
    ...
    [Migration("20230309092246_UpdateRelationship")]
            ...
            modelBuilder.Entity("Discussion.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 390, DateTimeKind.Local).AddTicks(6729),
                            Deleted = false,
                            FirstName = "Admin",
                            LastName = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 391, DateTimeKind.Local).AddTicks(1053),
                            Deleted = false,
                            FirstName = "Adam",
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 391, DateTimeKind.Local).AddTicks(1103),
                            Deleted = false,
                            FirstName = "Joe",
                            LastName = "Parker"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 391, DateTimeKind.Local).AddTicks(1107),
                            Deleted = false,
                            FirstName = "Patrick",
                            LastName = "Gargoles"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 391, DateTimeKind.Local).AddTicks(1110),
                            Deleted = false,
                            FirstName = "Shannon",
                            LastName = "Jones"
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("c7bf03eb-2696-4c5e-a2b0-228854fc81c8"),
                            CreatedDate = new DateTime(2023, 3, 9, 17, 22, 46, 391, DateTimeKind.Local).AddTicks(1112),
                            Deleted = false,
                            FirstName = "Hurish",
                            LastName = "Williams"
                        });
            ...
            modelBuilder.Entity("Discussion.Data.Entities.Discussion", b =>
                {
                    ...
                    b.HasOne("Discussion.Data.Entities.User", "Observer")
                        .WithOne()
                        .HasForeignKey("Discussion.Data.Entities.Discussion", "ObserverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
